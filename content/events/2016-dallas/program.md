...
<div class = "row">
  <div class = "col-md-6">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        Nathen Harvey - Delightful DevOps Days
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        Kevin Witherstine - NetDevOps - Network Engineer's Journey 
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        Allison Pollard/Zach Cannon - Encouraging Future Leaders
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        Franklin Mosley - RoboCop - Bringing Law and Order to CI/CD
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
  ...
  <div class = "col-md-6">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        Jeffrey Snover - The Devopsification of Windows Server 2016
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        Marissa Lerer - Where My Ladies At?
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        Shazad Brohi/Michael Hedgpeth - Orchestrating Independence
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        Michael Cote - DevOps for Normals
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
