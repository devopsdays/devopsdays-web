...
<div class = "row">
  <div class = "col-md-6">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        <a href="/events/2016-nashville/program/john-willis">John Willis - DevOps State of the Union</a>
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        <a href="/events/2016-nashville/program/suzie-prince">Suzie Prince - Tips for selling Continuous Delivery and DevOps to your business (from a business person)</a>
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        <a href="/events/2016-nashville/program/tim-o-guin">Tim O'Guin - Building a HIPAA compliant analytics platform in AWS</a>
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        <a href="/events/2016-nashville/program/nathen-harvey">Nathen Harvey - DevOps?! That's not my job!</a>
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        ...
        <ul>
          ...
          <li><a href="/events/2016-nashville/program/manuel-rodriguez-perez">Manuel Rodriguez-Perez - Please forgive me! – Confessions from a Silo and How I Learned to Believe in the Business Value of DevOps</a></li>
        </ul>
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
...
<!--    <div class = "row">
  ...
  <div class = "col-md-6">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        <a href="/events/2016-nashville/program/jason-hand">Jason Hand - Flaming Poo & The Human Response</a>
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
    ...
    <div class = "row">
      ...
      <div class = "col-md-6 box">
        <a href="/events/2016-nashville/program/scott-nasello">Scott Nasello - The first 500 nodes: The story of our journey at a Microsoft centric enterprise</a>
      </div>
    </div> <!-- end timeslot div -->
    <!-- this div is repeated for each timeslot -->
    <div class = "row">
