...
Type = "welcome"
aliases = ["/events/2019-chicago/"]
Description = "DevOpsDays Chicago is coming back in 2019! The group that brought you DevOpsDays Chicago 2014-2018 is back together and planning the 2019 event.  We're encouraged by the feedback from previous year's events and are determined to bring an improved experience and continue the DevOps conversation for 2019 in Chicago."
+++
...
<br><br>
The format of DevOpsDays Chicago includes a single track of 30 minute talks in the morning of each day, followed by Ignite talks (5 minute, auto-forwarding). We spend the rest of the afternoon in Open Spaces, which are considered a key portion of the event.
<div class = "row">
  <div class = "col-md-12">
