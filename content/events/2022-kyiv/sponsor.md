...
Title = "Sponsor"
Type = "event"
Description = "Sponsor devopsdays Kyiv 2022"
+++
...
In Oct 2022 the Kyiv organizers were planning to host their sixth DevOpsDays conference, but then everything changed. On February 24 Russia launched a dreadful wide-ranging attack on Ukraine. Our lives will never be the same.
<p>
...
<table class="table table-bordered table-hover">
  ...
  <tbody>
    ...
    <tr>
      <td>Logo on the broadcast splash screen (first, final and during breaks)</td>
      <td>+</td>
      <td>+</td>
      <td>+</td>
      <td></td>
    ...
    <tr>
      <td>Job listings on the virtual job board of the conference</td>
      <td>5</td>
      <td>2</td>
      <td></td>
      <td></td>
