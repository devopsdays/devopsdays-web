+++
Title = "DevOpsDays Medellín 2022"
Type = "welcome"
aliases = ["/events/2022-medellin/"]
Description = "Welcome to DevOpsDays Medellín 2022"
+++
<div class = "row">
  <div class="col-md-4">
    <img alt="DevOpsDays Medellin 2022" src="/events/2022-medellin/logo.png" class="img-fluid">
  </div>
  <div class="col-md-7">
    <h2>Nuestra Conferencia DevOpsDays Medellín vuelve y tendrá lugar el 28 y 29 de julio de 2022</h2>
    <p>
      The DevOpsDays conference arrives to Medellín once again, Be part on July 2022!
    </p>
 ...
 <!--        <div class="p-2">
        ...
        <div class="p-2">
          <a
            class="btn btn-secondary btn-block"
            href="/events/2022-medellin/contact"
            style="background-color:#329cae; border-color:#72c1cd" onMouseOver="this.style.backgroundColor='#23738e'"
            onMouseOut="this.style.backgroundColor='#329cae'"
          >
