...
Title = "Propose"
Type = "event"
Description = "Propose a talk for devopsdays Minneapolis 2022"
+++
  {{< cfp_dates >}}

Note: we require {{< event_link page="covid-19-policy" text="COVID-19 vaccination" >}} for all in-person participants; we will also consider pre-recorded talks.
