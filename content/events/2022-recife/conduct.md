...
Type = "event"
Description = "Código de Conduta - devopsdays Recife 2022"
+++
...
Prevenção à disseminação da Covid-19 é necessário para que tenhamos um bom evento. 
Uso de mascara será obrigatório para a entrada do evento junto ao comprovante de vacinação. 
Mascaras obrigatórias pro evento são: Cirurgicas descartável ou PFF2 ou N95. 
Teremos alcool disponível em vários locais do evento e no kit de boas vindas.
