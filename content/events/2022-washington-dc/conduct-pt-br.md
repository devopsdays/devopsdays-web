...
Title = "Conduta"
Type = "event"
Description = "Código de conduta do devopsdays Washington, D.C. 2022"
+++


Participantes, palestrantes, representantes de empresas e pessoas voluntárias no devopsdays Washington, D.C. 2022 são requeridos a concordar com o seguinte código de conduta. A organização irá aplicar este código pelo evento. Nós esperamos cooperação de todas as pessoas participando para garantir um ambiente seguro para todas as pessoas.
...
_O código de conduta do devopsdays Washington, D.C. 2022 é baseado em [confcodeofconduct.com](https://confcodeofconduct.com/index-pt-br.html)._
