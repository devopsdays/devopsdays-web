    ...
    <div class="col-md-12">
      <div class="row justify-content-center">
        <div class="d-flex p-2">
          ...
          style="margin-top: 10px; margin-bottom: 10px; background-color: black; color: white;   border-color: black;"
          href="/events/2023-oslo/sponsor">
          <i class="fa fa-money fa-lg"></i>&nbsp;&nbsp;&nbsp;Sponsor the Conference
        </a>
      </div>
      <div class="d-flex p-2">
        <a class="btn btn-primary btn-block"
        style="margin-top: 10px; margin-bottom: 10px; background-color: #FBB800; color: black;  border-color: black;"
        href="/events/2023-oslo/registration/">
        <!-- https://ti.to/devopsdaysoslo/2023/ -->
...
<div class="col-md-12">
  <div class="row">
    <div class="col-md-8">
      <h2 style=" padding-top: 28px ; ">Welcome to DevOpsDays Oslo 2023!</h2>
    ...
    <div class="row" style="padding-top: 28px ;">
      <div class="col-md-12">
        <div class="row justify-content-center">
          <div class="d-flex p-2">
            <a class="btn btn-primary btn-block"
            style="margin-top: 10px; margin-bottom: 10px; background-color: white;  color: black; border-color: black;"
            href="https://www.facebook.com/devopsnorway/">
        ...
        <div class="d-flex p-2">
          <a class="btn btn-primary btn-block"
          style="margin-top: 10px; margin-bottom: 10px; background-color: white;  color: black; border-color: black;"
          href="https://twitter.com/devopsdaysoslo/">
      ...
      <div class="d-flex p-2">
        <a class="btn btn-primary btn-block"
        style="margin-top: 10px; margin-bottom: 10px; background-color: white;  color: black; border-color: black;"
        href="https://www.meetup.com/devops-norway/">
