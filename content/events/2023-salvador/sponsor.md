...
Title = "Sponsor"
Type = "event"
Description = "Sponsor devopsdays Salvador 2023"
+++
...
up to R$ 1.000,00 receive the right to be publicized on social media and 1 registration for the event.</p>
    <!--<p style="font-size:18px">You can check more about sponsorship and the benefits here <a href=""><i class="fa fa-download" style="font-size:30px"></i></a></p> -->
</div>
