...
Talk_start_time = ""
Talk_end_time = ""
Title = "Le business case de la livraison continue"
Type = "talk"
Speakers = ["alexandre-walsh"]
+++

Livrer plus vite, être plus prévisible, réduire les retards de livraison: c’est une réalité avec laquelle nous devons conjuguer, et la science peut nous appuyer dans ce sens. On a beaucoup parlé dans les dernières années de l’importance de se mesurer, par exemple avec les métriques clés du DevOps (DORA) et le Value Stream Management.
