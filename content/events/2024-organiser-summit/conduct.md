...
Title = "Conduct"
Type = "event"
Description = "Code of conduct for devopsdays Organizer Summit 2024"
+++


All attendees, speakers, sponsors, and volunteers at devopsdays Organizer Summit 2024 are required to agree with the following code of conduct. Organizers will enforce this code throughout the event. We are expecting cooperation from all participants to help ensure a safe environment for everybody.
...
_The devopsdays Organizer Summit 2024 Code of Conduct is based on [confcodeofconduct.com](https://confcodeofconduct.com)._ 
=======
Title = "Code of Conduct"
Type = "event"
Description = "Code of conduct for devopsdays Org Summit 2024"
+++



### Purpose
The organizers of devopsdays Org Summit are committed to enabling an event at which everyone can participate in an inclusive, respectful and safe environment. All participants are expected to behave with integrity and respect towards all participants attending or involved with devopsdays Org Summit.

### Scope / Applicability 
The Code of Conduct applies to all devopsdays Org Summit events which includes conferences, workshops, meetups, social events and any other event organized by devopsdays Org Summit. 

The Code of Conduct applies to all participants at a devopsdays Org Summit event. Including attendees, speakers, sponsors, volunteers, organizers and guests.
...
### Attribution
The devopsdays Org Summit 2024 Code of Conduct is based on the [Contributor Covenant](https://www.contributor-covenant.org/version/2/1/code_of_conduct.html), version 2.1, and the [UN Code of Conduct](https://indico.un.org/static/plugins/un/assets/un-code-of-conduct.pdf).
