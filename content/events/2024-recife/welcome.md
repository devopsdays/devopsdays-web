+++
Title = "DevOpsDays Recife 2024"
Type = "welcome"
aliases = ["/events/2024-recife"]
Description = "DevOpsDays Recife 2024"
+++


<div style="padding: 10px;">
  <div style="padding-bottom: 1em;">
    <h2>DevOpsDays Recife 2024</h2>
  </div>
  <div style="padding-bottom: 1em;">
    <div class = "row">
      <div class = "col-md-2">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        {{< event_link url-key="registration_link" text="Em breve!" >}}
      </div>
    </div>
  </div>
  ...
  <div>
    <h4 style="padding-bottom: 1em;">
      <strong>O DevOpsDays Recife retorna em 2024!</strong>
    </h4>
    <p>
    Em nossa quarta edição do DevOpsDays Recife, queremos que todos tenhamos mais uma excelente oportunidade de compartilhar conhecimento, contar histórias, socializar e fazer novos amigos!
    </p>
    <p>
  ...
  <div style="padding-top:1em; padding-bottom:1em;" class="d-flex flex-row">
    <div>
      ...
      <div class="d-flex flex-row">
        ...
        <div style="witdh: auto; padding-right: 1em;">
          <a target="_blank" style="text-align:left;" class="btn btn-secondary btn-block" href="https://www.papercall.io/dodrec24"> <i class="fa fa-file-text-o fa-fw"></i> Call for Papers </a>
        </div>
        <div style="witdh: auto; padding-right: 1em;">
