...
talk_end_time = "14:30"
title = "Back to bas(h)ics"
type = "talk"
speakers = ["adam-genshaft"]
youtube = ""
vimeo = ""
speakerdeck = ""
slideshare = ""
...
You will implement your custom monorepo manager during the workshop using bash and its common utilities.

This workshop assumes a node js-based monorepo that *we’ll provide*, but the principles apply to any language and project.
A few of the things we’ll learn and use:
1. Bash output redirects
2. Expansions
3. Common gnu utilities like xargs, sed, and jq.
