...
Title = "Conduct"
Type = "event"
Description = "Code of conduct for devopsdays Eindhoven 2025"
+++

### Purpose
The organizers of devopsdays Eindhoven are committed to enabling an event at which everyone can participate in an inclusive, respectful and safe environment. All participants are expected to behave with integrity and respect towards all participants attending or involved with devopsdays Eindhoven.

### Scope / Applicability 
The Code of Conduct applies to all devopsdays Eindhoven events which includes conferences, workshops, meetups, social events and any other event organized by devopsdays Eindhoven. 

The Code of Conduct applies to all participants at a devopsdays Eindhoven event. Including attendees, speakers, sponsors, volunteers, organizers and guests.
...
### Attribution
The devopsdays Eindhoven 2025 Code of Conduct is based on the [Contributor Covenant](https://www.contributor-covenant.org/version/2/1/code_of_conduct.html), version 2.1, and the [UN Code of Conduct](https://indico.un.org/static/plugins/un/assets/un-code-of-conduct.pdf).
