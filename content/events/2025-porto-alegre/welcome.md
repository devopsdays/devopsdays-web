+++
Title = "devopsdays Porto Alegre 2025"
Type = "welcome"
aliases = ["/events/2025-porto-alegre/"]
Description = "devopsdays Porto Alegre 2025"
+++
...
<br>
<h2 style ="color:#5C889F">DEVOPSDAYS PORTO ALEGRE - 2025</h2>
<p align="justify">
O DevOpsDays POA é a edição de Porto Alegre do DevOpsDays, um evento global voltado para cultura DevOps, SRE, automação e práticas modernas de entrega de software. Atualmente, ele acontece em um único dia, concentrando palestras curtas, ignite talks e open spaces em um formato dinâmico e acessível

O evento reúne profissionais de tecnologia da região Sul e de outras partes do Brasil em um ambiente colaborativo, focado em aprendizado real, trocas de experiências e networking sem formalidade.

Se você quer se atualizar, se conectar com a comunidade e entender como outras empresas estão resolvendo desafios de entrega contínua e operações modernas, o DevOpsDays POA é o principal evento na região Sul para isso, tudo em um único dia intenso e prático.
</p>
