...
<div class="card col-lg-12 border-0"><div class="embed-responsive embed-responsive-16by9">
    ...
    <div class="card-body">
    <h3>The demonstration video shows:</h3>
<ol>
<li> How to deploy an AI-powered chatbot on the F5 Distributed Cloud Platform.
<li> The workings of Retrieval Augmented Generation.
<li> F5's approach to securing your generative AI assets.
<li> Outcome of an AI-powered RAG-Enabled Chatbot with a AI-powered Chatbot (straight with LLM)
</ol>
</p></div>
