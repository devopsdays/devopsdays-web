+++
Title = "DevOpsDays Santiago 2026"
Type = "welcome"
aliases = ["/events/2026-santiago/"]
Description = "Bienvenidos a la segunda edicion DevOpsDays Santiago de Chile"
+++
...
<div class="row" style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
  ...
  <p style="font-size: 1.1em; color: #333;">
    ...
    2 días de charlas, actividades, y muchos premios!<br>
    Keynotes de Oradores renombrados en el mundo DevOps<br>
    Charlas y talleres de Oradores que postulan y nuestros Patrocinadores
  </p>
    ...
    <div class="d-flex flex-row mt-4">
      <div class="col-md-12 text-center">
        <a class="btn btn-secondary btn-block"
           href="/events/2026-santiago/contact"
...
<ul style="list-style-type: none; padding-left: 0;">
   <li style="margin-bottom: 10px;">
      <strong>Apertura del Evento:</strong> 09:00 AM
   </li>
   <li style="margin-bottom: 10px;">
      <strong>Cierre:</strong> 17:00 PM
   </li>
</ul>