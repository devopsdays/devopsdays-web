+++
Title = "devopsdays Vilnius 2026"
Type = "welcome"
aliases = ["/events/2026-vilnius/"]
Description = "devopsdays Vilnius 2026"
+++

<div class="row">
    <div class="col-md-4">
        <img alt="DevOpsDays Vilnius 2026" src="/events/2026-vilnius/logo.png" class="img-fluid logo">
    </div>
    <div class="col-md-7">
        <h3>DevOpsDays Vilnius 2026</h3>
        <p>
            Devopsdays Vilnius is self organizing and not a profit-oriented event. At three previous events we gathered 200+
            like-minded IT engineers to learn and share. Whether you're a seasoned Devops enthusiast or just starting
            your journey, Devopsdays Vilnius 2026 has something for you. Join us and gain valuable insights and build
            ...
            <div class="col-md-12">
                <div class="d-flex p-2">
                    <a class="btn btn-secondary btn-block button-secondary"
                        ...
                        href="https://fienta.com/devopsdays-vilnius-2026">Propose a talk</a>
                </div>
                <div class="d-flex p-2">
                    <a class="btn btn-secondary btn-block button-secondary"
                        style="background-color: #1bff9f; border-color: #1bff9f; color: #000000"
                ...
                <div class="d-flex p-2">
                    <a class="btn btn-secondary btn-block button-secondary"
                        style="background-color: #1bff9f; border-color: #1bff9f; color: #000000"
                        href="/events/2026-vilnius/contact">Contact Organizers</a>
                </div>
                <p><strong>Video from Devopsdays Vilnius 2025</strong></p>
                <p>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/hPIIY6ndDjU?si=nK6K6-2cQ9yD-Jhc"
