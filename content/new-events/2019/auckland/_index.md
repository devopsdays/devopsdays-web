...
description = "Devopsdays is returning to Auckland!"
...
masthead_background = "auckland-skyline.jpg"
startdate = 2019-10-21T00:00:00+13:00
enddate = 2019-10-22T23:59:59+13:00
cfp_date_start = 2019-06-01T00:00:00+12:00
cfp_date_end = 2019-07-19T23:59:59+12:00
cfp_date_announce = 2019-08-12T00:00:00+12:00
registration_date_start = 2019-06-01T00:00:00+12:00
registration_date_end = 2019-10-21T00:00:00+13:00
coordinates = "-36.851831,174.761512"
location = "Aotea Centre Auckland"
location_address = "Aotea Centre, 50 Mayoral Dr, Auckland, 1010"
organizer_email = "organisers-auckland-2019@devopsdays.org"
proposal_email = "proposals-auckland-2019@devopsdays.org"
sponsors_accepted = "no"
sponsor_levels = [
    { id = "platinum", label = "Platinum", max = 0 },
    { id = "gold", label = "Gold", max = 0 },
    { id = "silver", label = "Silver", max = 0 },
    { id = "diversity", label = "Diversity Ticket", max = 1 },
    { id = "lanyard", label = "Lanyard", max = 1 },
    { id = "media", label = "Media", max = 1 },
    { id = "community", label = "Community", max = 1 },
]
sponsors = [
    { name = "2019-nz-sumologic", level = "platinum" },
    { name = "googlecloud", level = "platinum" },
    { name = "microsoftnz", level = "platinum" },
    { name = "buildkite", level = "platinum" },
    { name = "section6", level = "gold" },
    { name = "rancher", level = "gold" },
    { name = "hashicorp", level = "gold" },
    { name = "pagerduty", level = "gold" },
    { name = "sonatype", level = "gold" },
    { name = "assurity", level = "gold" },
    { name = "xero", level = "silver" },
    { name = "gitlab", level = "silver" },
    { name = "countdown", level = "silver" },
    { name = "2019-clearpoint", level = "gold" },
    { name = "buildkite", level = "diversity" },
    { name = "datacom", level = "gold" },
    { name = "iag", level = "silver" },
