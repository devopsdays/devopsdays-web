...
description = "devopsdays is coming to Portugal for the first time!"
...
ga_tracking_id = "UA-133818809-1"
startdate = 2019-06-03T00:00:00+01:00
enddate = 2019-06-04T23:59:59+01:00
cfp_date_start = 2019-02-04T00:00:00+00:00
cfp_date_end = 2019-03-31T23:59:59+00:00
cfp_date_announce = 2019-04-10T23:59:59+01:00
cfp_link = "https://www.papercall.io/devopsdaysportugal2019"
coordinates = "38.707073, -9.148971"
location = "Lisbon, Portugal"
location_address = "EDP - Energias de Portugal, Av. 24 de Julho 12A, 1249-300 Lisboa"
organizer_email = "organizers-portugal-2019@devopsdays.org"
proposal_email = "proposals-portugal-2019@devopsdays.org"
...
sponsors = [
    { name = "edp", level = "gold" },
    { name = "outsystems", level = "gold" },
    { name = "accenture-pt", level = "gold" },
    { name = "microsoft", level = "gold" },
    { name = "cgi", level = "gold" },
    { name = "devscope", level = "silver" },
    { name = "thoughtworks-gocd", level = "silver" },
    { name = "fujitsu-pt", level = "silver" },
    { name = "xebialabs", level = "silver" },
    { name = "man", level = "silver" },
    { name = "claranet", level = "bronze" },
    { name = "laredoute", level = "bronze" },
    { name = "i2s", level = "bronze" },
    { name = "gfi", level = "bronze" },
    { name = "itcenter", level = "bronze" },
    { name = "feedzai", level = "bronze" },
    { name = "intrasurance", level = "bronze" },
    { name = "vodafone-pt", level = "bronze" },
    { name = "bosch", level = "bronze", url = "https://www.bosch.pt/" },
    { name = "devopslisbon", level = "community" },
    { name = "devopsporto", level = "community" },
    { name = "bitmaker", level = "community" },
    { name = "apogep", level = "community" },
    { name = "agileportugal", level = "community" },
    { name = "agileconnect", level = "community" },
    { name = "ptwit", level = "community" },
    { name = "winb", level = "community" },
    { name = "geekgirlsportugal", level = "community" },
    { name = "pydata-lx", level = "community" },
    { name = "netponto", level = "community" },
    { name = "dspt", level = "community" },
    { name = "devopsbraga", level = "community" },
    { name = "caceresdevops", level = "community" },
    { name = "ticeleiria", level = "community" },
    { name = "techeventsonline", level = "community" },
]
navigation = [
    { name = "propose" },
    { name = "location" },
