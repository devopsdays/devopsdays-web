...
description = "DevOpsDays is coming back to Geneva!"
...
startdate = 2020-02-24T08:00:00+01:00
enddate = 2020-02-25T17:00:00+01:00
cfp_date_start = 2019-09-25T08:00:00+01:00
cfp_date_end = 2019-12-01T23:59:00+01:00
cfp_date_announce = 2019-12-17T12:00:00+01:00
coordinates = "46.1758689, 6.1364216"
location = "Geneva"
location_address = "Campus de Battelle, Rue de la Tambourine 17, 1227 Carouge"
organizer_email = "geneva@devopsdays.org"
sponsors_accepted = "yes"
sponsor_levels = [
    { id = "gold", label = "Gold", max = 8 },
    { id = "silver", label = "Silver", max = 8 },
    { id = "bronze", label = "Bronze", max = 12 },
    { id = "community", label = "Community", max = 12 },
]
sponsors = [
    { name = "tuleap", level = "gold", url = "https://tuleap.org" },
    { name = "hidora", level = "gold", url = "https://hidora.com/" },
    { name = "cross-systems", level = "gold", url = "https://www.cross-systems.ch" },
    { name = "dbi-services", level = "silver" },
    { name = "camptocamp", level = "silver" },
    { name = "adexcel", level = "gold" },
    { name = "serial", level = "silver" },
    { name = "pure-storage", level = "gold" },
    { name = "nutanix", level = "gold" },
    { name = "smartwave-xebialabs", level = "gold" },
    { name = "cisel", level = "bronze" },
    { name = "net4all", level = "silver" },
    { name = "gitlab", level = "silver" },
    { name = "globaz", level = "silver" },
    { name = "d2iq", level = "silver" },
    { name = "sword", level = "silver" },
    { name = "techfirm", level = "gold" },
    { name = "swissdevjobs", level = "community" },
    { name = "heg-geneva", level = "community" },
]
navigation = [
    { name = "location" },
    { name = "newsletter" },
