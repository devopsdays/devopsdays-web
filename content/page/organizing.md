...
- You must look for ways to create opportunities for conversation and collaboration during the event. Traditionally, this is done through the use of [open spaces](https://www.devopsdays.org/open-space-format/), but it can take many forms. Other examples include (but are not limited to) interactive workshops, attendee-led roundtables, office hours, birds-of-a-feather groups, and Q&A sessions.
