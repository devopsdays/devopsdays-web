...
| `registration_date_end`   | YYYY-MM-DD | No       | The date you will close registration. Controls the appearance of the "Register" button on the "Welcome" page. You can set `registration_date_start` without `registration_date_end`. Can be a blank value.                                                                                                                                                                   | 2016-01-05                                            |
