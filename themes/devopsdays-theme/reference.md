...
| `cfp_open`                | String     | No       | Either "true" or "false". Can be blank. This controls whether or not the "propose" button shows on your event page. _Deprecated field; if you have set `cfp_date_start` and `cfp_date_end` they will serve the same purpose._                                  | "true"                                                                                                                         |
...
```
{{< img src="/sponsors/k/kcd-porto.png" class="img-fluid mx-auto" alt="Website KCD Porto" >}}
```
