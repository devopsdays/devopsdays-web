...
1. Once you have created a logo graphic, place it in `assets/events/images/yyyy-city/logo.png`. (The file MUST be called `logo.png`.) The sample welcome page has a commented-out element to display a logo named in this way.
1. The image used for your event on the front page of the site will be the image located in `assets/events/images/yyyy-city/logo.png`, which will be cropped automatically cropped to square. If you want to override this, you can place a square image in `assets/events/images/yyyy-city/logo-square.png`.
